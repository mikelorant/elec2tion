...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Determines if an AWS EC2 instance is elected.'
  spec.description   = 'Determines if an AWS EC2 instance is elected based on it being the first entry in the security group.'
  ...
  spec.add_development_dependency 'gemfury', '~> 0.5'
